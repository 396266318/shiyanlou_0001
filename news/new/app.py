...
file1 = os.path.join(file_patn, file_list[0])
file2 = os.path.join(file_patn, file_list[1])
...
# shiyanlou_json = file_content(file1).get('title')
# helloworld_json = file_content(file2).get('title')
...
def file(filename):
    ...
    #         'created_time2': file_content1.get('created_time'),
    #         'content1': file_content1.get('content'),
    #         'content2': file_content2.get('content'),
    #     }
    #
    # elif filename == 'filename.json':
